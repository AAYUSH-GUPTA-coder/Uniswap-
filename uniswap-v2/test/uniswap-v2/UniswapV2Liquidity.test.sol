...
contract UniswapV2LiquidityTest is Test {
    ...
    function test_addLiquidity() public {
        ...
        vm.prank(user);
        (uint256 dai, uint256 weth, uint256 liquidity) = router.addLiquidity(
            DAI,
            WETH,
            1000000 * 1e18,
            100 * 1e18,
        ...
        console2.log("dai amount", dai);
        console2.log("weth amount", weth);
        console2.log("LP amount", liquidity);
    ...
    function test_removeLiquidity() public {
        ...
        console2.log("Amount of DAI", amountA);
        console2.log("Amount of WETH", amountB);
